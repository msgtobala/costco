...
const Model1: React.FC<{ position?: Vector3; scale?: number }> = (
  props: any,
) => {
  const group = useRef<any>();
  const { nodes, materials, animations } = useGLTF(
    'https://kmulehampttbgpnlsmgh.supabase.co/storage/v1/object/public/costco-models/fridge_animated_v3.glb?t=2024-05-30T07%3A06%3A02.508Z',
  ) as GLTFResult;
